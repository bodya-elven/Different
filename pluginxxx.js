                    ...
                    if (isModels || isStudios || isCategories) {
                        ...
                        for (var m = 0; m < mEls.length; m++) {
                            ...
                            if (nameM && urlM) {
                                results.push({
                                    ...
                                    is_grid: true,
                                    is_models: isModels,
                                    time: count ? count : '' // Передаємо дані для плашки
                                });
                            }
                        }
                    } else {
                        ...
                        for (var i = 0; i < elements.length; i++) {
                            ...
                            results.push({
                                ...
                                picture: img,
                                img: img,
                                time: time // Передаємо час для плашки
                            });
                        }
                    }
                    return results;
