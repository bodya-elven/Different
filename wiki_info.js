(function () {
    ...
    function WikiInfoPlugin() {
        ...
        // ОРИГІНАЛЬНИЙ SVG код Вікіпедії
        ...
        this.render = function (data, html) {
            var container = $(html);
            // ТУТ БУЛА ПОМИЛКА: випадково з'явилося слово "容器" замість "container"
            ...
            var style = '<style>' +
                ...
                /* ОСЬ ВИПРАВЛЕННЯ ДЛЯ ПОСИЛАНЬ: inherit робить колір посилань ідентичним тексту статті (#efefef) */
